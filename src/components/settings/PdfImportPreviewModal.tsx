...
const ALL_VARIABLES = [
  ...
  { var: "{{valor_por_extenso}}", desc: "Valor final por extenso", group: "Financeiro" },
  { var: "{{valor_total_produtos}}", desc: "Valor total dos produtos", group: "Financeiro" },
  { var: "{{valor_total_ambientes}}", desc: "Valor total dos ambientes", group: "Financeiro" },
  ...
  { var: "{{bairro_loja}}", desc: "Bairro da loja", group: "Empresa" },
  { var: "{{cidade_loja}}", desc: "Cidade da loja", group: "Empresa" },
  { var: "{{uf_loja}}", desc: "UF da loja", group: "Empresa" },
  { var: "{{cep_loja}}", desc: "CEP da loja", group: "Empresa" },
  ...
  { var: "{{total_ambientes}}", desc: "Total dos ambientes", group: "Tabelas" },
  ...
  { var: "{{ambientes_prazos_lista}}", desc: "Lista de ambientes com prazos (texto)", group: "Tabelas" },
  ...
  { var: "{{endereco_entrega_completo}}", desc: "Endereço de entrega completo", group: "Endereço" },
  { var: "{{nome_ambiente_N}}", desc: "Nome do ambiente N (ex: _1, _2...)", group: "Ambientes" },
  { var: "{{fornecedor_ambiente_N}}", desc: "Fornecedor do ambiente N", group: "Ambientes" },
  { var: "{{valor_ambiente_N}}", desc: "Valor do ambiente N", group: "Ambientes" },
  { var: "{{corpo_ambiente_N}}", desc: "Corpo do ambiente N", group: "Ambientes" },
  { var: "{{porta_ambiente_N}}", desc: "Porta do ambiente N", group: "Ambientes" },
  { var: "{{puxador_ambiente_N}}", desc: "Puxador do ambiente N", group: "Ambientes" },
  { var: "{{complemento_ambiente_N}}", desc: "Complemento do ambiente N", group: "Ambientes" },
  { var: "{{modelo_ambiente_N}}", desc: "Modelo do ambiente N", group: "Ambientes" },
  { var: "{{prazo_entrega_ambiente_N}}", desc: "Prazo de entrega do ambiente N", group: "Ambientes" },
  { var: "{{titulos_ambiente_N}}", desc: "Título do ambiente N", group: "Ambientes" },
  { var: "{{quantidade_ambiente_N}}", desc: "Quantidade do ambiente N", group: "Ambientes" },
  { var: "{{descricao_ambiente_N}}", desc: "Descrição do ambiente N", group: "Ambientes" },
  { var: "{{produto_catalogo_nome_N}}", desc: "Nome do produto N", group: "Catálogo" },
  { var: "{{produto_catalogo_codigo_N}}", desc: "Código do produto N", group: "Catálogo" },
  { var: "{{produto_catalogo_qtd_N}}", desc: "Quantidade do produto N", group: "Catálogo" },
  { var: "{{produto_catalogo_valor_N}}", desc: "Valor do produto N", group: "Catálogo" },
  { var: "{{produto_catalogo_subtotal_N}}", desc: "Subtotal do produto N", group: "Catálogo" },
  { var: "{{quantidade_produtos_catalogo}}", desc: "Nº de produtos do catálogo", group: "Catálogo" },
  { var: "{{indicador_nome}}", desc: "Nome do indicador", group: "Outros" },
  { var: "{{indicador_comissao}}", desc: "Comissão do indicador", group: "Outros" },
  { var: "{{telefones_uteis}}", desc: "Tabela de telefones úteis", group: "Outros" },
  { var: "{{telefone_util_setor_N}}", desc: "Setor do telefone útil N", group: "Outros" },
  { var: "{{telefone_util_responsavel_N}}", desc: "Responsável do telefone útil N", group: "Outros" },
  { var: "{{telefone_util_numero_N}}", desc: "Número do telefone útil N", group: "Outros" },
];
