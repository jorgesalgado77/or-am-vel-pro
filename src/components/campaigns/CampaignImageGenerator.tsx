...
import { Image, Download, Palette, Type, Layout, Sparkles, Copy } from "lucide-react";
...
const TEMPLATES: Template[] = [
  {
    id: "coz-promo", nome: "Cozinha — Promoção", categoria: "cozinha",
    width: 1080, height: 1080, bgColor: "#1a1a2e", accentColor: "#e94560", textColor: "#ffffff",
    layout: "centered",
    placeholders: { headline: "Cozinha Planejada", subtext: "Projeto 3D Gratuito + Parcele em 60x", cta: "SOLICITE AGORA", badge: "PROMOÇÃO" },
  },
  {
    id: "coz-story", nome: "Cozinha — Stories", categoria: "cozinha",
    width: 1080, height: 1920, bgColor: "#0f3460", accentColor: "#e94560", textColor: "#ffffff",
    layout: "split",
    placeholders: { headline: "Sua Cozinha dos Sonhos", subtext: "Projeto 3D 100% Gratuito", cta: "ARRASTE PRA CIMA" },
  },
  {
    id: "qrt-feed", nome: "Quarto — Feed", categoria: "quarto",
    width: 1080, height: 1080, bgColor: "#2d3436", accentColor: "#6c5ce7", textColor: "#ffffff",
    layout: "centered",
    placeholders: { headline: "Quarto Planejado", subtext: "Armários sob medida com design exclusivo", cta: "PEÇA SEU PROJETO", badge: "EXCLUSIVO" },
  },
  {
    id: "qrt-story", nome: "Quarto — Stories", categoria: "quarto",
    width: 1080, height: 1920, bgColor: "#2d3436", accentColor: "#a29bfe", textColor: "#ffffff",
    layout: "split",
    placeholders: { headline: "Closet dos Sonhos", subtext: "100% sob medida para você", cta: "SAIBA MAIS" },
  },
  {
    id: "plan-feed", nome: "Planejados — Feed", categoria: "planejados",
    width: 1080, height: 1080, bgColor: "#222f3e", accentColor: "#ff6348", textColor: "#ffffff",
    layout: "centered",
    placeholders: { headline: "Móveis Planejados", subtext: "Todos os ambientes com projeto 3D grátis", cta: "FALE CONOSCO", badge: "ATÉ 20% OFF" },
  },
  {
    id: "plan-banner", nome: "Planejados — Banner", categoria: "planejados",
    width: 1200, height: 628, bgColor: "#130f40", accentColor: "#f39c12", textColor: "#ffffff",
    layout: "banner",
    placeholders: { headline: "Promoção Imperdível", subtext: "Projeto 3D Gratuito + Condições Especiais", cta: "APROVEITE" },
  },
  {
    id: "maes-feed", nome: "Dia das Mães — Feed", categoria: "datas",
    width: 1080, height: 1080, bgColor: "#ffeaa7", accentColor: "#e17055", textColor: "#2d3436",
    layout: "centered",
    placeholders: { headline: "Presente para Mãe", subtext: "A cozinha que ela sempre sonhou", cta: "SURPREENDA ELA", badge: "DIA DAS MÃES" },
  },
  {
    id: "bf-feed", nome: "Black Friday — Feed", categoria: "datas",
    width: 1080, height: 1080, bgColor: "#000000", accentColor: "#fdcb6e", textColor: "#ffffff",
    layout: "centered",
    placeholders: { headline: "BLACK FRIDAY", subtext: "Até 30% OFF em todos os ambientes", cta: "GARANTA JÁ", badge: "ATÉ 30% OFF" },
  },
  {
    id: "natal-feed", nome: "Natal — Feed", categoria: "datas",
    width: 1080, height: 1080, bgColor: "#c0392b", accentColor: "#f1c40f", textColor: "#ffffff",
    layout: "centered",
    placeholders: { headline: "Natal com Desconto", subtext: "Renove sua casa para as festas", cta: "APROVEITE", badge: "NATAL" },
  },
];

function CanvasPreview({ template, customTexts }: { template: Template; customTexts: { headline: string; subtext: string; cta: string; badge?: string; storeName: string } }) {
  ...
  return (
    <div
      ...
      style={{ width: w, height: h, backgroundColor: template.bgColor }}
    >
      {/* Decorative elements */}
      <div className="absolute inset-0 opacity-10" style={{
        background: `radial-gradient(circle at 20% 80%, ${template.accentColor} 0%, transparent 50%), radial-gradient(circle at 80% 20%, ${template.accentColor} 0%, transparent 50%)`
      }} />

      {/* Badge */}
      {customTexts.badge && (
        <div className="absolute top-3 right-3 px-2 py-0.5 rounded text-[8px] font-bold tracking-wider"
      ...
      {/* Content */}
      <div className={`absolute inset-0 flex flex-col items-center justify-center p-4 text-center gap-1.5 ${template.layout === "split" ? "justify-end pb-8" : ""}`}>
        <p className="text-[7px] font-medium uppercase tracking-widest opacity-70" style={{ color: template.accentColor }}>
          {customTexts.storeName}
        </p>
        <h3 className="font-bold leading-tight" style={{ color: template.textColor, fontSize: template.layout === "banner" ? 16 : 14 }}>
          {customTexts.headline}
        </h3>
        <p className="text-[9px] opacity-80 max-w-[80%]" style={{ color: template.textColor }}>
          {customTexts.subtext}
        </p>
        <div className="mt-1 px-3 py-1 rounded-full text-[8px] font-bold tracking-wide"
          style={{ backgroundColor: template.accentColor, color: template.bgColor }}>
          {customTexts.cta}
        </div>
      </div>
...
export function CampaignImageGenerator() {
  ...
  const generateAndDownload = () => {
    ...
    grad1.addColorStop(0, accentColor + "30");
    ...
    grad2.addColorStop(0, accentColor + "20");
    ...
    for (let i = 0; i < 5; i++) {
      ctx.beginPath();
      ctx.arc(canvas.width * 0.5, canvas.height * 0.5, 100 + i * 60, 0, Math.PI * 2);
      ctx.stroke();
    }
    ...
    if (badge) {
      ...
      ctx.beginPath();
      ctx.roundRect(canvas.width - bw - 30, 30, bw, bh, 6);
      ctx.fill();
      ctx.fillStyle = bgColor;
      ctx.textAlign = "center";
      ctx.fillText(badge, canvas.width - bw / 2 - 30, 30 + bh / 2 + 5);
    }
    ...
    ctx.fillStyle = accentColor;
    ctx.beginPath();
    ctx.roundRect(canvas.width / 2 - ctaW / 2, ctaY, ctaW, ctaH, 25);
    ctx.fill();
    ctx.fillStyle = bgColor;
    ctx.textAlign = "center";
    ctx.fillText(cta, canvas.width / 2, ctaY + ctaH / 2 + 5);
      ...
      <CardContent className="space-y-4">
        ...
        <div>
          ...
          <div className="flex gap-1.5 mb-3 flex-wrap">
            {["todos", "cozinha", "quarto", "planejados", "datas"].map(c => (
              <Badge key={c} variant={filterCat === c ? "default" : "outline"} className="cursor-pointer capitalize text-xs"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            <CanvasPreview template={{ ...selectedTemplate, bgColor, accentColor }} customTexts={{ headline, subtext, cta, badge, storeName }} />
