...
export function AppSidebar({
  ...
  const navItems = [
    ...
    { id: "liberacao", label: "Liberação Técnica", icon: ShieldCheck, perm: "liberacao" as const, show: hasPermission("liberacao") || hasPermission("liberacao_tecnica") || cargoLower.includes("gerente") || cargoLower.includes("administrador") || cargoLower.includes("liberador") || cargoLower.includes("conferente") || cargoLower.includes("tecnico") || cargoLower.includes("técnico"), badge: null },
