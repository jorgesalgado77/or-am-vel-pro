...
export function TaskFilters({ dateFilter, onDateFilterChange, typeFilter, onTypeFilterChange, customStart, customEnd, onCustomStartChange, onCustomEndChange }: Props) {
  return (
